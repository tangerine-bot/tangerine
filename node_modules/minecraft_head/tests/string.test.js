...
test('UUID to NAME', done => {
    mc.uuidToName('3c358264b4564bdeab1efe1023db6679')
        .then(data => {
...
test('Get Skin', done => {
    mc.getSkin('3c358264b4564bdeab1efe1023db6679')
        .then(data => {
...
test('Get Name History', done => {
    mc.getNameHistory('be1d2795758c44a3b0b81c9dcd370560')
        .then(data => {
...
test('Get Name History at Time', done => {
    mc.getNameAtDate('be1d2795758c44a3b0b81c9dcd370560', new Date(2015, 5, 1))
        .then(data => {
